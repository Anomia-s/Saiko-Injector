/**
 * Function: Unwind@140205b20
 * Address:  140205b20
 * Signature: undefined Unwind@140205b20(void)
 * Body size: 162 bytes
 */


void Unwind_140205b20(undefined8 param_1,longlong param_2)

{
  ...
  if (*(char *)(param_2 + 0x118) == '\x01') {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x120)) {
      lVar5 = FUN_1401a9e60();
