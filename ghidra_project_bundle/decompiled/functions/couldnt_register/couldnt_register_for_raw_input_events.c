/**
 * Function: couldnt_register_for_raw_input_events
 * Address:  140443f90
 * Signature: undefined couldnt_register_for_raw_input_events(void)
 * Body size: 132 bytes
 */


ulonglong couldnt_register_for_raw_input_events(HWND param_1)

{
  ...
  if (DAT_1416f17a0 == '\x01') {
    ...
    local_28.usUsage = 5;
    local_28.dwFlags = 0x2100;
    local_28.hwndTarget = param_1;
    BVar1 = RegisterRawInputDevices(&local_28,1,0x10);
    if (BVar1 == 0) {
      uVar2 = FUN_1400fbed0("Couldn\'t register for raw input events");
