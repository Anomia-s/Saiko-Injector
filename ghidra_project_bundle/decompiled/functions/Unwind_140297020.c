/**
 * Function: Unwind@140297020
 * Address:  140297020
 * Signature: undefined Unwind@140297020(void)
 * Body size: 142 bytes
 */


void Unwind_140297020(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x270) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x268)) {
      lVar5 = FUN_1401a9e60();
