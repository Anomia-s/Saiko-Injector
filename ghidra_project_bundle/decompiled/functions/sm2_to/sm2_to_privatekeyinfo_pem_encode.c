/**
 * Function: sm2_to_privatekeyinfo_pem_encode
 * Address:  140d53760
 * Signature: undefined sm2_to_privatekeyinfo_pem_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x621,
               "sm2_to_PrivateKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d53845;
    }
    uVar2 = FUN_140d676d0(lVar3,param_3,0x198,"SM2 PRIVATE KEY",FUN_140d67ff0,FUN_140d681e0,param_1)
    ;
  }
LAB_140d53845:
  FUN_140b73150(lVar3);
