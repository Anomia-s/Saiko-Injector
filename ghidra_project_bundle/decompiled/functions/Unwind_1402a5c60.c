/**
 * Function: Unwind@1402a5c60
 * Address:  1402a5c60
 * Signature: undefined Unwind@1402a5c60(void)
 * Body size: 141 bytes
 */


void Unwind_1402a5c60(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x30) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x28)) {
      lVar5 = FUN_1401a9e60();
  ...
  *(undefined8 *)(param_2 + 0x40) = *(undefined8 *)(param_2 + 0x38);
  return;
}
