/**
 * Function: ed448_to_subjectpublickeyinfo_pem_encode
 * Address:  140d54a40
 * Signature: undefined ed448_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x631,
               "ed448_to_SubjectPublicKeyInfo_pem_encode");
