/**
 * Function: ed448_to_privatekeyinfo_pem_encode
 * Address:  140d547b0
 * Signature: undefined ed448_to_privatekeyinfo_pem_encode(void)
 * Body size: 313 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x62f,
               "ed448_to_PrivateKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5488e;
    }
    uVar2 = FUN_140d676d0(lVar3,param_3,0x440,"ED448 PRIVATE KEY",0,FUN_140d68310,param_1);
  }
LAB_140d5488e:
  FUN_140b73150(lVar3);
  return uVar2;
