/**
 * Function: Unwind@1402c8c50
 * Address:  1402c8c50
 * Signature: undefined Unwind@1402c8c50(void)
 * Body size: 177 bytes
 */


void Unwind_1402c8c50(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x2980) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x2958)) {
      lVar5 = FUN_1401a9e60();
