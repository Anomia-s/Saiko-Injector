/**
 * Function: x25519_to_subjectpublickeyinfo_der_encode
 * Address:  140d55100
 * Signature: undefined x25519_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x636,
               "x25519_to_SubjectPublicKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d551ef;
    }
    lVar4 = key_to_pubkey(param_3,0x40a,0,0xffffffff,FUN_140d68280,param_1);
    if (lVar4 != 0) {
