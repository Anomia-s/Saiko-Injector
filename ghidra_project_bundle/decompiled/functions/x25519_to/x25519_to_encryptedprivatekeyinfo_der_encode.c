/**
 * Function: x25519_to_encryptedprivatekeyinfo_der_encode
 * Address:  140d54be0
 * Signature: undefined x25519_to_encryptedprivatekeyinfo_der_encode(void)
 * Body size: 335 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x632,
               "x25519_to_EncryptedPrivateKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d54cd4;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x40a,0,0xffffffff,FUN_140d68310,param_1);
      if (lVar4 != 0) {
