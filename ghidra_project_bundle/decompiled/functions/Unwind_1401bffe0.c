/**
 * Function: Unwind@1401bffe0
 * Address:  1401bffe0
 * Signature: undefined Unwind@1401bffe0(void)
 * Body size: 231 bytes
 */


void Unwind_1401bffe0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x137) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xb0)) {
      lVar5 = FUN_1401a9e60();
