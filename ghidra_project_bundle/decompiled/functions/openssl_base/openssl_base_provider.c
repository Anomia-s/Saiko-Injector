/**
 * Function: openssl_base_provider
 * Address:  140cdb5c0
 * Signature: undefined openssl_base_provider(void)
 * Body size: 207 bytes
 */
...
bool openssl_base_provider(undefined8 param_1,undefined8 param_2)

{
  ...
  if ((lVar3 != 0) && (iVar1 = FUN_140b95260(lVar3,"OpenSSL Base Provider"), iVar1 == 0)) {
    return false;
  }
