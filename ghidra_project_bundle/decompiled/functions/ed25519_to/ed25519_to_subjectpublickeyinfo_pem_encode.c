/**
 * Function: ed25519_to_subjectpublickeyinfo_pem_encode
 * Address:  140d54230
 * Signature: undefined ed25519_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x62b,
               "ed25519_to_SubjectPublicKeyInfo_pem_encode");
