/**
 * Function: ed25519_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d53d10
 * Signature: undefined ed25519_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 335 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x627,
               "ed25519_to_EncryptedPrivateKeyInfo_pem_encode");
