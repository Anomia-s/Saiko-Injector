/**
 * Function: ed25519_to_encryptedprivatekeyinfo_der_encode
 * Address:  140d53bc0
 * Signature: undefined ed25519_to_encryptedprivatekeyinfo_der_encode(void)
 * Body size: 335 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x626,
               "ed25519_to_EncryptedPrivateKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d53cb4;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x43f,0,0xffffffff,FUN_140d68310,param_1);
      if (lVar4 != 0) {
