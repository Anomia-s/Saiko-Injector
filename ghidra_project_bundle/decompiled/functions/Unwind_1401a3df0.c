/**
 * Function: Unwind@1401a3df0
 * Address:  1401a3df0
 * Signature: undefined Unwind@1401a3df0(void)
 * Body size: 136 bytes
 */


void Unwind_1401a3df0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x8f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x80)) {
      lVar5 = FUN_1401a9e60();
