/**
 * Function: Unwind@14055ed50
 * Address:  14055ed50
 * Signature: undefined Unwind@14055ed50(void)
 * Body size: 133 bytes
 */


void Unwind_14055ed50(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x4f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x40)) {
      lVar5 = FUN_1401a9e60();
