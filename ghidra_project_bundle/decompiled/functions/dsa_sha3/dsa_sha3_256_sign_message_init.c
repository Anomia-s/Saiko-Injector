/**
 * Function: dsa_sha3_256_sign_message_init
 * Address:  140d3eea0
 * Signature: undefined dsa_sha3_256_sign_message_init(void)
 * Body size: 488 bytes
 */
...
undefined8 dsa_sha3_256_sign_message_init(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x4000;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,"SHA3-256",0,"DSA-SHA3-256 Sign Message Init");
  if (iVar1 == 0) {
    return 0;
  }
