/**
 * Function: Unwind@1402c29e0
 * Address:  1402c29e0
 * Signature: undefined Unwind@1402c29e0(void)
 * Body size: 192 bytes
 */


void Unwind_1402c29e0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xd30) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xce0)) {
      lVar5 = FUN_1401a9e60();
