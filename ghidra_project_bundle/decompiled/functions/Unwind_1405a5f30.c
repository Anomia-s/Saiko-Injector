/**
 * Function: Unwind@1405a5f30
 * Address:  1405a5f30
 * Signature: undefined Unwind@1405a5f30(void)
 * Body size: 152 bytes
 */


void Unwind_1405a5f30(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x5d7) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x5a8)) {
      lVar5 = FUN_1401a9e60();
