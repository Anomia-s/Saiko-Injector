/**
 * Function: rsa_to_privatekeyinfo_der_encode
 * Address:  140d61f80
 * Signature: undefined rsa_to_privatekeyinfo_der_encode(void)
 * Body size: 400 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5f6,
               "rsa_to_PrivateKeyInfo_der_encode");
    ...
    if (iVar1 == 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d62067;
        }
        uVar2 = FUN_140d67590(lVar3,param_3,6,"RSA PRIVATE KEY",FUN_140d68440,FUN_140d685f0,param_1)
        ;
      }
LAB_140d62067:
      FUN_140b73150(lVar3);
