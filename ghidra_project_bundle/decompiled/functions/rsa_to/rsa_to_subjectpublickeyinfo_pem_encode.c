/**
 * Function: rsa_to_subjectpublickeyinfo_pem_encode
 * Address:  140d62820
 * Signature: undefined rsa_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 400 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5f9,
               "rsa_to_SubjectPublicKeyInfo_pem_encode");
    ...
    if (iVar1 == 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d62907;
        }
        uVar2 = FUN_140d67810(lVar3,param_3,6,"RSA PUBLIC KEY",FUN_140d68440,FUN_140d68610,param_1);
      }
LAB_140d62907:
      FUN_140b73150(lVar3);
      return uVar2;
