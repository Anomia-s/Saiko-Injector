/**
 * Function: rsa_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d61b80
 * Signature: undefined rsa_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 468 bytes
 */
...

{
  ...
  uStack_10 = 0x140d61b95;
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5f5,
               "rsa_to_EncryptedPrivateKeyInfo_pem_encode");
