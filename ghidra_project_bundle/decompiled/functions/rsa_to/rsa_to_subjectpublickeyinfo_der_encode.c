/**
 * Function: rsa_to_subjectpublickeyinfo_der_encode
 * Address:  140d624a0
 * Signature: undefined rsa_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 467 bytes
 */
...

{
  ...
  uStack_10 = 0x140d624b6;
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5f8,
               "rsa_to_SubjectPublicKeyInfo_der_encode");
    ...
    if (iVar1 == 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d625ca;
        }
        local_18 = 0;
        local_res20[0] = 0xffffffff;
        iVar1 = FUN_140d68440(param_3,6,*(undefined4 *)(param_1 + 1),&local_18,local_res20);
        if (iVar1 != 0) {
          lVar4 = key_to_pubkey(param_3,6,local_18,local_res20[0],FUN_140d68610,param_1);
          if (lVar4 != 0) {
