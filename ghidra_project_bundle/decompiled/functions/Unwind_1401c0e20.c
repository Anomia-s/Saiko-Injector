/**
 * Function: Unwind@1401c0e20
 * Address:  1401c0e20
 * Signature: undefined Unwind@1401c0e20(void)
 * Body size: 136 bytes
 */


void Unwind_1401c0e20(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xcf) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xc0)) {
      lVar5 = FUN_1401a9e60();
