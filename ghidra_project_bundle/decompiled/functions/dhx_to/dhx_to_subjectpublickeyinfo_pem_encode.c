/**
 * Function: dhx_to_subjectpublickeyinfo_pem_encode
 * Address:  140d661f0
 * Signature: undefined dhx_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 400 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x60c,
               "dhx_to_SubjectPublicKeyInfo_pem_encode");
    ...
    if (iVar1 != 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d662d7;
        }
        uVar2 = FUN_140d67810(lVar3,param_3,0x398,"X9.42 DH PUBLIC KEY",FUN_140d679c0,FUN_140d67ac0,
                              param_1);
      }
LAB_140d662d7:
      FUN_140b73150(lVar3);
