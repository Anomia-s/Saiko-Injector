/**
 * Function: dhx_to_encryptedprivatekeyinfo_der_encode
 * Address:  140d65200
 * Signature: undefined dhx_to_encryptedprivatekeyinfo_der_encode(void)
 * Body size: 652 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x607,
               "dhx_to_EncryptedPrivateKeyInfo_der_encode");
