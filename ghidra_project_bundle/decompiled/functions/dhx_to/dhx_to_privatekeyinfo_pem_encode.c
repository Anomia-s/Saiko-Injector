/**
 * Function: dhx_to_privatekeyinfo_pem_encode
 * Address:  140d65c80
 * Signature: undefined dhx_to_privatekeyinfo_pem_encode(void)
 * Body size: 400 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x60a,
               "dhx_to_PrivateKeyInfo_pem_encode");
    ...
    if (iVar1 != 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d65d67;
        }
        uVar2 = FUN_140d676d0(lVar3,param_3,0x398,"X9.42 DH PRIVATE KEY",FUN_140d679c0,FUN_140d67b90
                              ,param_1);
      }
LAB_140d65d67:
      FUN_140b73150(lVar3);
