/**
 * Function: dhx_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d655d0
 * Signature: undefined dhx_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 652 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x608,
               "dhx_to_EncryptedPrivateKeyInfo_pem_encode");
    ...
    if (iVar1 != 0) {
      ...
      if (lVar3 != 0) {
        ...
        if (*(int *)((longlong)param_1 + 0xc) != 0) {
          ...
          iVar1 = FUN_140ca6d60(param_3,piVar4 + 2);
          *piVar4 = iVar1;
          if (iVar1 < 1) {
            d_aplatformplatformopenssl_srccryptoerrerr_lo();
            d_aplatformplatformopenssl_srccryptoerrerr_lo
          ...
          piVar4[1] = 0x10;
          lVar5 = p8info_to_encp8(param_3,0x398,piVar4,0x10,FUN_140d67b90,param_1);
          uVar2 = 0;
          if (lVar5 != 0) {
            uVar2 = encrypted_private_key(lVar3,lVar5);
          }
          FUN_140c6f680(lVar5);
        }
      }
