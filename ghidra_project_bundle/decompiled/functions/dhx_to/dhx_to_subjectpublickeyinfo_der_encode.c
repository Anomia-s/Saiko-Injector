/**
 * Function: dhx_to_subjectpublickeyinfo_der_encode
 * Address:  140d65e10
 * Signature: undefined dhx_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 642 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x60b,
               "dhx_to_SubjectPublicKeyInfo_der_encode");
    ...
    if (iVar1 != 0) {
      ...
      if (lVar3 != 0) {
        ...
        *piVar4 = iVar1;
        ...
        piVar4[1] = 0x10;
        lVar5 = key_to_pubkey(param_3,0x398,piVar4,0x10,FUN_140d67ac0,param_1);
        if (lVar5 != 0) {
