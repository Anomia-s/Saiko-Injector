/**
 * Function: Unwind@1404be720
 * Address:  1404be720
 * Signature: undefined Unwind@1404be720(void)
 * Body size: 222 bytes
 */


void Unwind_1404be720(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x65f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x500)) {
      lVar5 = FUN_1401a9e60();
