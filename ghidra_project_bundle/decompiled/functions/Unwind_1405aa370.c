/**
 * Function: Unwind@1405aa370
 * Address:  1405aa370
 * Signature: undefined Unwind@1405aa370(void)
 * Body size: 294 bytes
 */


void Unwind_1405aa370(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x737) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x720)) {
      lVar5 = FUN_1401a9e60();
