/**
 * Function: rsapss_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d62e20
 * Signature: undefined rsapss_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 471 bytes
 */
...

{
  ...
  uStack_10 = 0x140d62e35;
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5fb,
               "rsapss_to_EncryptedPrivateKeyInfo_pem_encode");
    ...
    if (iVar1 == 0x1000) {
      ...
      if (lVar3 != 0) {
        ...
        if (*(int *)((longlong)param_1 + 0xc) != 0) {
          ...
          uVar6 = 0;
          if (iVar1 != 0) {
            lVar4 = p8info_to_encp8(param_3,0x390,local_18,local_res20[0],FUN_140d685f0,param_1);
            if (lVar4 != 0) {
