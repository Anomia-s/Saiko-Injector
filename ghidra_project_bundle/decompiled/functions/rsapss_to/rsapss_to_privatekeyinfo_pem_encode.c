/**
 * Function: rsapss_to_privatekeyinfo_pem_encode
 * Address:  140d63430
 * Signature: undefined rsapss_to_privatekeyinfo_pem_encode(void)
 * Body size: 403 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5fd,
               "rsapss_to_PrivateKeyInfo_pem_encode");
    ...
    if (iVar1 == 0x1000) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d6351a;
        }
        uVar2 = FUN_140d676d0(lVar3,param_3,0x390,"RSA-PSS PRIVATE KEY",FUN_140d68440,FUN_140d685f0,
                              param_1);
      }
LAB_140d6351a:
      FUN_140b73150(lVar3);
