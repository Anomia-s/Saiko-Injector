/**
 * Function: rsapss_to_encryptedprivatekeyinfo_der_encode
 * Address:  140d62b00
 * Signature: undefined rsapss_to_encryptedprivatekeyinfo_der_encode(void)
 * Body size: 471 bytes
 */
...

{
  ...
  uStack_10 = 0x140d62b15;
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x5fa,
               "rsapss_to_EncryptedPrivateKeyInfo_der_encode");
