/**
 * Function: backend_url_is_empty
 * Address:  1405b7380
 * Signature: undefined backend_url_is_empty(void)
 * Body size: 3295 bytes
 */
...
undefined2 *
backend_url_is_empty(undefined2 *param_1,longlong param_2,undefined8 *param_3,undefined8 *param_4)

{
  ...
  *(undefined8 *)(param_1 + 0x44) = 0;
  ...
  if (*(longlong *)(param_2 + 0x10) == 0) {
    ...
    cJSON_AddStringToObject(uVar7,"mfa_token",param_3);
    if (0xf < (ulonglong)param_4[3]) {
      param_4 = (undefined8 *)*param_4;
    }
    cJSON_AddStringToObject(uVar7,"code",param_4);
    ...
    if (0xf < local_160) {
      ...
      if (0xfff < uVar11) {
        ...
        if (0x1f < (ulonglong)((local_178 + -8) - lVar12)) goto LAB_1405b803c;
        uVar11 = local_160 + 0x28;
      }
      thunk_FUN_140b68ba8(lVar12,uVar11);
    }
    if (0xf < local_140) {
      lVar13 = CONCAT17(uStack_151,local_158);
      uVar11 = local_140 + 1;
      lVar12 = lVar13;
      if (0xfff < uVar11) {
        lVar12 = *(longlong *)(lVar13 + -8);
        if (0x1f < (ulonglong)((lVar13 + -8) - lVar12)) goto LAB_1405b803c;
    ...
    if (local_220 != 0) {
      ...
      if (0xfff < uVar11) {
        ...
        if (0x1f < (ulonglong)((local_220 + -8) - lVar12)) goto LAB_1405b803c;
        uVar11 = uVar11 + 0x27;
      }
      thunk_FUN_140b68ba8(lVar12,uVar11);
      local_220 = 0;
    ...
    *(undefined8 *)local_230[1] = 0;
    ...
    if (0xf < local_1a0) {
      ...
      if (0xfff < uVar11) {
        ...
        if (0x1f < (ulonglong)((local_1b8[0] + -8) - lVar12)) goto LAB_1405b803c;
    ...
    if (0xf < uStack_120) {
      ...
      if (0xfff < uVar11) {
        ...
        if ((char *)0x1f < local_138 + (-8 - (longlong)pcVar23)) goto LAB_1405b803c;
      ...
      *pcVar8 = '\0';
      ...
      if (0xf < uVar11) {
        ...
        if (0xfff < uVar16) {
          ...
          if (0x1f < (ulonglong)((lVar12 + -8) - lVar13)) goto LAB_1405b803c;
          uVar16 = uVar11 + 0x28;
        }
      ...
      if (lVar12 == 0) {
        ...
        if (*(int *)(CONCAT44(uStack_284,local_288) + 0x20) == 200) {
          ...
          if (iVar6 == 0) {
            ...
            if (uStack_1e0 - local_1e8 < 0x17) {
              pppppppuVar14 =
                   (uint *******)
                   FUN_140008af0(local_1f8,0x17,local_1e8,0,"MFA login failed (HTTP ",0x17);
            }
            else {
              _Src = pppppppuVar14;
              if (0xf < uStack_1e0) {
              ...
              pcVar8 = (char *)0x17;
              if (("" < (char *)((longlong)_Src + local_1e8) && _Src < (uint *******)0x1413a1184) &&
                 (pcVar8 = (char *)((longlong)_Src + -0x1413a116d),
                 _Src < "MFA login failed (HTTP " || pcVar8 == (char *)0x0)) {
                pcVar8 = (char *)0x0;
              }
              sVar9 = local_1e8 + 1;
              ...
              local_1e8 = local_1e8 + 0x17;
              memmove((char *)((longlong)pppppppuVar18 + 0x17),_Src,sVar9);
              memcpy(_Src,"MFA login failed (HTTP ",(size_t)pcVar8);
              memcpy((char *)((longlong)_Src + (longlong)pcVar8),pcVar8 + 0x1413a1184,
                     0x17 - (longlong)pcVar8);
            }
          ...
          if (0xf < uVar11) {
            ...
            if (0xfff < uVar16) {
              ...
              if (0x1f < (ulonglong)((lVar13 + -8) - lVar19)) goto LAB_1405b803c;
              uVar16 = uVar11 + 0x28;
            }
          ...
          if (iVar6 == 0) {
            if ((uint ******)0xf < ppppppuStack_100) {
              ...
              if ((uint ******)0xfff < ppppppuVar21) {
                ...
                if (0x1f < (ulonglong)((lVar19 + -8) - lVar13)) goto LAB_1405b803c;
