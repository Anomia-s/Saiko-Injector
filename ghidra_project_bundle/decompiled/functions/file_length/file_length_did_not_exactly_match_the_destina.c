/**
 * Function: file_length_did_not_exactly_match_the_destina
 * Address:  140459920
 * Signature: undefined file_length_did_not_exactly_match_the_destina(void)
 * Body size: 210 bytes
 */


ulonglong file_length_did_not_exactly_match_the_destina
...

{
  ...
  if (local_30 == 0) {
    ...
    lVar2 = parameter_s_is_invalid(local_30,&DAT_14135eecf);
    if (lVar2 == 0) {
      uVar4 = 0;
    }
    else {
      ...
      if (lVar3 != param_4) {
        FUN_1400fbed0("File length did not exactly match the destination length");
      }
      FUN_1400f9140(lVar2);
    }
    FUN_140160cf0(lVar1);
