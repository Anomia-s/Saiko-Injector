/**
 * Function: Unwind@140207380
 * Address:  140207380
 * Signature: undefined Unwind@140207380(void)
 * Body size: 162 bytes
 */


void Unwind_140207380(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x1a0) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x198)) {
      lVar5 = FUN_1401a9e60();
