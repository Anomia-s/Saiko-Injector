/**
 * Function: Unwind@14055e480
 * Address:  14055e480
 * Signature: undefined Unwind@14055e480(void)
 * Body size: 125 bytes
 */


void Unwind_14055e480(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x5f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x50)) {
      lVar5 = FUN_1401a9e60();
