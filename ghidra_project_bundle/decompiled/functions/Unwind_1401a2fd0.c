/**
 * Function: Unwind@1401a2fd0
 * Address:  1401a2fd0
 * Signature: undefined Unwind@1401a2fd0(void)
 * Body size: 288 bytes
 */


void Unwind_1401a2fd0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x200) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x1f8)) {
      lVar5 = FUN_1401a9e60();
