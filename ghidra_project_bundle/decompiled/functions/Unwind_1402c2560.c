/**
 * Function: Unwind@1402c2560
 * Address:  1402c2560
 * Signature: undefined Unwind@1402c2560(void)
 * Body size: 192 bytes
 */


void Unwind_1402c2560(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400017d0(param_2 + 0xd70);
  if ((*(byte *)(param_2 + 0xd50) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xd68)) {
      lVar5 = FUN_1401a9e60();
