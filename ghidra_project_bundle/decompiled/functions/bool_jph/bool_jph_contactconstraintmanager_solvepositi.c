/**
 * Function: bool_jph_contactconstraintmanager_solvepositi
 * Address:  1400dec00
 * Signature: undefined bool_jph_contactconstraintmanager_solvepositi(void)
 * Body size: 376 bytes
 */


byte bool_jph_contactconstraintmanager_solvepositi(longlong param_1,uint *param_2,uint *param_3)
  ...
  if (param_2 < param_3) {
    ...
    if (*(longlong *)(param_1 + 0xa8) != 0) {
      ...
      do {
        ...
        uVar3 = (**(code **)(&DAT_140de4530 +
                            (ulonglong)*(byte *)(plVar4[1] + 0x78) * 8 +
                            (ulonglong)*(byte *)(*plVar4 + 0x78) * 0x18))
                          (plVar4,*plVar4,plVar4[1],*(undefined8 *)(param_1 + 0x88));
        auVar9 = in_ZMM6._0_16_;
...
LAB_1400ded30:
  if (pauVar8 != (undefined1 (*) [16])0x0) {
    ...
    auVar9 = vmovntdq_avx(SUB6416(ZEXT864(0x141399187),0));
    *pauVar8 = auVar9;
