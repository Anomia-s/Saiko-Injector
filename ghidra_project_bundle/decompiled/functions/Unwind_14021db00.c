/**
 * Function: Unwind@14021db00
 * Address:  14021db00
 * Signature: undefined Unwind@14021db00(void)
 * Body size: 132 bytes
 */


void Unwind_14021db00(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xe6) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xd0)) {
      lVar5 = FUN_1401a9e60();
