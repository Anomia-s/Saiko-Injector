/**
 * Function: joystick_only_has_d_hats
 * Address:  140129b00
 * Signature: undefined joystick_only_has_d_hats(void)
 * Body size: 371 bytes
 */


undefined1 joystick_only_has_d_hats(longlong param_1,int param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (param_2 < *(int *)(param_1 + 0x60)) {
      uVar4 = *(undefined1 *)(*(longlong *)(param_1 + 0x68) + (longlong)param_2);
    }
    else {
      FUN_1400fbed0("Joystick only has %d hats");
      uVar4 = 0;
    }
    DAT_141525658 = DAT_141525658 + -1;
    if ((DAT_141525658 == 0 && (DAT_141525648 & 1) == 0) &&
