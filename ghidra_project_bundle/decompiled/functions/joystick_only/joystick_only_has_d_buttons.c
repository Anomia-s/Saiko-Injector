/**
 * Function: joystick_only_has_d_buttons
 * Address:  140129e40
 * Signature: undefined joystick_only_has_d_buttons(void)
 * Body size: 371 bytes
 */


undefined1 joystick_only_has_d_buttons(longlong param_1,int param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (param_2 < *(int *)(param_1 + 0x70)) {
      uVar4 = *(undefined1 *)(*(longlong *)(param_1 + 0x78) + (longlong)param_2);
    }
    else {
      FUN_1400fbed0("Joystick only has %d buttons");
      uVar4 = 0;
    }
    DAT_141525658 = DAT_141525658 + -1;
    if ((DAT_141525658 == 0 && (DAT_141525648 & 1) == 0) &&
