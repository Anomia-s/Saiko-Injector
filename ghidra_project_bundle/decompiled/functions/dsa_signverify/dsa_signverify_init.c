 ...
 * Address:  140d3faf0
 * Signature: undefined dsa_signverify_init(void)
 * Body size: 488 bytes
 */
...
undefined8 dsa_signverify_init(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,"SHA3-512",0,"DSA-SHA3-512 Sign Init");
  if (iVar1 == 0) {
    return 0;
  }
