/**
 * Function: Unwind@140281970
 * Address:  140281970
 * Signature: undefined Unwind@140281970(void)
 * Body size: 141 bytes
 */


void Unwind_140281970(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400017d0(param_2 + 0x50);
  if ((*(byte *)(param_2 + 0x77) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x68)) {
      lVar5 = FUN_1401a9e60();
