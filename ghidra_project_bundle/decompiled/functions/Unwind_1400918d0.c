/**
 * Function: Unwind@1400918d0
 * Address:  1400918d0
 * Signature: undefined Unwind@1400918d0(void)
 * Body size: 129 bytes
 */


void Unwind_1400918d0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x57) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x48)) {
      lVar5 = FUN_1401a9e60();
