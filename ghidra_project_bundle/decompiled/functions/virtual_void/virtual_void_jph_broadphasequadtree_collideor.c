/**
 * Function: virtual_void_jph_broadphasequadtree_collideor
 * Address:  14038bec0
 * Signature: undefined virtual_void_jph_broadphasequadtree_collideor(void)
 * Body size: 951 bytes
 */


void virtual_void_jph_broadphasequadtree_collideor
    ...
    do {
      ...
      if ((*(int *)(lVar9 + 0x40 + (ulonglong)(uVar11 << 7)) != 0) &&
        ...
        if (*(char *)(*(longlong *)((longlong)ThreadLocalStoragePointer + (ulonglong)_tls_index * 8)
          ...
          __dyn_tls_on_demand_init();
          lVar12 = *plVar1;
          if (lVar12 != 0) goto LAB_14038c167;
LAB_14038c1ca:
          pauVar8 = (undefined1 (*) [16])0x0;
        }
        else {
          lVar12 = *plVar1;
          if (lVar12 == 0) goto LAB_14038c1ca;
LAB_14038c167:
  ...
  if (local_b8 != (undefined1 (*) [16])0x0) {
    ...
    auVar13 = vmovntdq_avx(SUB6416(ZEXT864(0x14132be68),0));
    *local_b8 = auVar13;
    auVar13 = vmovntdq_avx(auVar15);
    local_b8[1] = auVar13;
  }
