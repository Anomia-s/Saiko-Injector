/**
 * Function: ec_to_privatekeyinfo_pem_encode
 * Address:  140d52de0
 * Signature: undefined ec_to_privatekeyinfo_pem_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x61a,
               "ec_to_PrivateKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d52ec5;
    }
    uVar2 = FUN_140d676d0(lVar3,param_3,0x198,"EC PRIVATE KEY",FUN_140d67ff0,FUN_140d681e0,param_1);
  }
LAB_140d52ec5:
  FUN_140b73150(lVar3);
  return uVar2;
