/**
 * Function: ec_to_subjectpublickeyinfo_pem_encode
 * Address:  140d53170
 * Signature: undefined ec_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x61c,
               "ec_to_SubjectPublicKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d53255;
    }
    uVar2 = FUN_140d67810(lVar3,param_3,0x198,"EC PUBLIC KEY",FUN_140d67ff0,FUN_140d68160,param_1);
  }
LAB_140d53255:
  FUN_140b73150(lVar3);
  return uVar2;
