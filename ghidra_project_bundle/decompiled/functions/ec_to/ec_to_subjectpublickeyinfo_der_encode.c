/**
 * Function: ec_to_subjectpublickeyinfo_der_encode
 * Address:  140d52f80
 * Signature: undefined ec_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 387 bytes
 */
...

{
  ...
  uStack_10 = 0x140d52f90;
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x61b,
               "ec_to_SubjectPublicKeyInfo_der_encode");
