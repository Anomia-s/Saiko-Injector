/**
 * Function: ec_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d66d80
 * Signature: undefined ec_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 392 bytes
 */
...

{
  ...
  uStack_10 = 0x140d66d90;
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x618,
               "ec_to_EncryptedPrivateKeyInfo_pem_encode");
