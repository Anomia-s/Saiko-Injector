/**
 * Function: ec_to_privatekeyinfo_der_encode
 * Address:  140d66f10
 * Signature: undefined ec_to_privatekeyinfo_der_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x619,
               "ec_to_PrivateKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d66ff5;
    }
    uVar2 = FUN_140d67590(lVar3,param_3,0x198,"EC PRIVATE KEY",FUN_140d67ff0,FUN_140d681e0,param_1);
  }
LAB_140d66ff5:
  FUN_140b73150(lVar3);
  return uVar2;
