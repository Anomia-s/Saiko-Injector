/**
 * Function: cannot_be_cleared_with_cleartexturefloat_beca
 * Address:  1406e10d0
 * Signature: void __thiscall cannot_be_cleared_with_cleartexturefloat_beca(void * this, longlong * param_1, undefined4 * param_2, undefined8 param_3)
 * Body size: 1151 bytes
 */
...
void __thiscall
cannot_be_cleared_with_cleartexturefloat_beca
          (void *this,longlong *param_1,undefined4 *param_2,undefined8 param_3)

{
  ...
  cVar2 = operation_requires_at_least(this,1,"clearTextureFloat");
  if (cVar2 == '\0') {
    return;
  }
  ...
  if ((*(byte *)(lVar4 + 0x13) & 0x30) == 0) {
    if (*(char *)(lVar4 + 0x12) != '\0') {
      if ((*(char *)(lVar3 + 0x41) == '\0') && (*(char *)(lVar3 + 0x42) == '\0')) {
        ...
        FUN_1400e5ec0(uVar5,
                      " cannot be cleared with clearTextureFloat because it was created with both isRenderTarget = false and isUAV = false."
                     );
      ...
      (**(code **)(**(longlong **)((longlong)this + 0x10) + 0x40))
    ...
    uVar5 = FUN_1400e5ec0(uVar5,uVar6);
    FUN_1400e5ec0(uVar5,
                  " cannot be cleared with clearTextureFloat because it\'s an integer texture. Use clearTextureUInt instead."
                 );
...
LAB_1406e1426:
      pvVar10 = (void *)**pplVar8;
      if (pvVar10 != (void *)0x0) {
        uVar7 = uVar7 - (longlong)pvVar10;
        if (uVar7 < 0x10) {
          local_48 = uVar7;
          memmove(&local_58,pvVar10,uVar7);
  ...
  uVar5 = FUN_1400e5ec0(uVar5,uVar6);
  FUN_1400e5ec0(uVar5,
                " cannot be cleared with clearTextureFloat because it\'s a depth-stencil texture. Use clearDepthStencilTexture instead."
               );
  local_58 = (undefined8 *******)0x0;
  uStack_50 = 0;
  local_48 = 0;
  ...
  if (((local_c8 & 0x22) == 2) || (uVar7 = *local_f8, uVar7 == 0)) {
    if (((local_c8 & 4) == 0) && (*local_100 != 0)) {
      ...
      if (pvVar10 != (void *)0x0) goto LAB_1406e1208;
    }
LAB_1406e1224:
    ...
    if (pvVar10 == (void *)0x0) goto LAB_1406e1224;
LAB_1406e1208:
    uVar7 = uVar7 - (longlong)pvVar10;
    if (0xf < uVar7) {
      FUN_1400069b0(&local_58,uVar7);
...
LAB_1406e1357:
  if (0xf < local_40) {
    ...
    thunk_FUN_140b68ba8(pppppppuVar9,uVar7);
  }
