/**
 * Function: Unwind@14027f8c0
 * Address:  14027f8c0
 * Signature: undefined Unwind@14027f8c0(void)
 * Body size: 155 bytes
 */


void Unwind_14027f8c0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xd0) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xd8)) {
      lVar5 = FUN_1401a9e60();
