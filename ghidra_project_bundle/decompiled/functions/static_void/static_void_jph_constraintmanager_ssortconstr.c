/**
 * Function: static_void_jph_constraintmanager_ssortconstr
 * Address:  140375a60
 * Signature: undefined static_void_jph_constraintmanager_ssortconstr(void)
 * Body size: 267 bytes
 */


void static_void_jph_constraintmanager_ssortconstr
  ...
  if (lVar2 != 0) {
    ...
    if ((ulonglong)uVar1 < 0x10000) {
      *(uint *)(lVar2 + 0x200020) = uVar1 + 1;
      ...
      uVar3 = rdtsc();
      FUN_140375b70(param_2,param_3,param_1);
      uVar4 = rdtsc();
      auVar6._8_8_ = 0;
      auVar6._0_8_ = uVar3;
      auVar7._8_8_ = 0;
      ...
      auVar6 = vmovntdq_avx(SUB6416(ZEXT864(0x1413991e4),0));
