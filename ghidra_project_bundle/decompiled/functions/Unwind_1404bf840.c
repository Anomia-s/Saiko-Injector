/**
 * Function: Unwind@1404bf840
 * Address:  1404bf840
 * Signature: undefined Unwind@1404bf840(void)
 * Body size: 162 bytes
 */


void Unwind_1404bf840(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x587) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x578)) {
      lVar5 = FUN_1401a9e60();
