/**
 * Function: Unwind@1401a2eb0
 * Address:  1401a2eb0
 * Signature: undefined Unwind@1401a2eb0(void)
 * Body size: 288 bytes
 */


void Unwind_1401a2eb0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x217) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x208)) {
      lVar5 = FUN_1401a9e60();
