/**
 * Function: Unwind@1402b8190
 * Address:  1402b8190
 * Signature: undefined Unwind@1402b8190(void)
 * Body size: 140 bytes
 */


void Unwind_1402b8190(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400440d0(param_2 + 0x80);
  if ((*(byte *)(param_2 + 0xb6) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x70)) {
      lVar5 = FUN_1401a9e60();
