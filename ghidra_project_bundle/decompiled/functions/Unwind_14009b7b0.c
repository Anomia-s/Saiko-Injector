/**
 * Function: Unwind@14009b7b0
 * Address:  14009b7b0
 * Signature: undefined Unwind@14009b7b0(void)
 * Body size: 144 bytes
 */


void Unwind_14009b7b0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x8f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x60)) {
      lVar5 = FUN_1401a9e60();
