 ...
 * Address:  140d60400
 * Signature: undefined rsa_private_key(void)
 * Body size: 583 bytes
 */
...
bool rsa_private_key(undefined8 *param_1,undefined8 param_2,longlong param_3,longlong param_4,
...

{
  ...
  if (param_4 == 0) {
    if ((param_5 & 1) == 0) {
      if ((param_5 & 2) == 0) goto LAB_140d60601;
      bVar3 = false;
      if (param_3 == 0) goto LAB_140d60445;
      ...
      if (iVar1 == 0) {
        ...
        if ((lVar2 != 0) &&
          ...
          iVar1 = FUN_140bf44b0(FUN_140d68610,param_1,"RSA PUBLIC KEY",lVar2,param_3,param_1[2],0,0,
                                0,0);
          bVar3 = 0 < iVar1;
        }
        FUN_140b73150(lVar2);
...
LAB_140d60445:
      ...
      if (iVar1 == 0) {
        ...
        if ((lVar2 != 0) &&
           ((param_6 == 0 || (iVar1 = FUN_140c714b0(param_1 + 3,param_6,param_7), iVar1 != 0)))) {
          iVar1 = FUN_140bf44b0(FUN_140d685f0,param_1,"RSA PRIVATE KEY",lVar2,param_3,param_1[2],0,0
...
LAB_140d60601:
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x6c1,
