 ...
 * Function: ParseError
 * Address:  1406d9660
 * Signature: ParseError * __thiscall ParseError(ParseError * this, longlong param_1)
 * Body size: 290 bytes
 */


ParseError * __thiscall Luau::ParseError::ParseError(ParseError *this,longlong param_1)

{
  ...
  this->vftablePtr = (ParseError_vftable *)&std::exception::vftable;
