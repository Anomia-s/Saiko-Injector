/**
 * Function: Unwind@1402092d0
 * Address:  1402092d0
 * Signature: undefined Unwind@1402092d0(void)
 * Body size: 155 bytes
 */


void Unwind_1402092d0(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400440d0(*(undefined8 *)(param_2 + 0xa0));
  if ((*(byte *)(param_2 + 0xb6) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x38)) {
      lVar5 = FUN_1401a9e60();
