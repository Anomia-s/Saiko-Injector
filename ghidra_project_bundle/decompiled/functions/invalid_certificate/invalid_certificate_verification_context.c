/**
 * Function: invalid_certificate_verification_context
 * Address:  140c2f6b0
 * Signature: undefined invalid_certificate_verification_context(void)
 * Body size: 807 bytes
 */


char * invalid_certificate_verification_context(undefined4 param_1)
