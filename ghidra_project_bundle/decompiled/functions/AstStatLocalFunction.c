 ...
 * Address:  1406c37c0
 * Signature: void __thiscall AstStatLocalFunction(AstStatLocalFunction * this, undefined8 * param_1, undefined8 param_2, undefined8 param_3)
 * Body size: 52 bytes
 */
...
Luau::AstStatLocalFunction::AstStatLocalFunction
          (AstStatLocalFunction *this,undefined8 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  this->vftablePtr = (AstStatLocalFunction_vftable *)&AstNode::vftable;
