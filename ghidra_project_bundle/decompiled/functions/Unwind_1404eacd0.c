/**
 * Function: Unwind@1404eacd0
 * Address:  1404eacd0
 * Signature: undefined Unwind@1404eacd0(void)
 * Body size: 142 bytes
 */


void Unwind_1404eacd0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x13ff) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x13e0)) {
      lVar5 = FUN_1401a9e60();
