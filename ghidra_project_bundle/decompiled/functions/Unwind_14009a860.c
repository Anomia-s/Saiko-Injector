/**
 * Function: Unwind@14009a860
 * Address:  14009a860
 * Signature: undefined Unwind@14009a860(void)
 * Body size: 150 bytes
 */


void Unwind_14009a860(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400440d0(*(undefined8 *)(param_2 + 0x198));
  if ((*(byte *)(param_2 + 0x1a7) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 400)) {
      lVar5 = FUN_1401a9e60();
