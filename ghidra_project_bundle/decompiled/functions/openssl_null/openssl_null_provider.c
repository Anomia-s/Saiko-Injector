/**
 * Function: openssl_null_provider
 * Address:  140cdb800
 * Signature: undefined openssl_null_provider(void)
 * Body size: 207 bytes
 */
...
bool openssl_null_provider(undefined8 param_1,undefined8 param_2)

{
  ...
  if ((lVar3 != 0) && (iVar1 = FUN_140b95260(lVar3,"OpenSSL Null Provider"), iVar1 == 0)) {
    return false;
  }
