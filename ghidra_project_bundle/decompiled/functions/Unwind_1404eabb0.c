/**
 * Function: Unwind@1404eabb0
 * Address:  1404eabb0
 * Signature: undefined Unwind@1404eabb0(void)
 * Body size: 142 bytes
 */


void Unwind_1404eabb0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x140f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x13e8)) {
      lVar5 = FUN_1401a9e60();
