/**
 * Function: providersimplementationssignaturedsa_sigc
 * Address:  140d406c0
 * Signature: undefined providersimplementationssignaturedsa_sigc(void)
 * Body size: 362 bytes
 */
...
undefined8
providersimplementationssignaturedsa_sigc(longlong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (local_58 != 0) {
    ...
    if ((lVar4 != 0) && (iVar1 = FUN_140b93940(lVar4,param_1 + 0x20), iVar1 == 0)) {
      return 0;
    }
