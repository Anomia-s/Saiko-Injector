/**
 * Function: ml_dsa_44_to_encryptedprivatekeyinfo_pem_enco
 * Address:  140d629b0
 * Signature: undefined ml_dsa_44_to_encryptedprivatekeyinfo_pem_enco(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_dsa_44_to_encryptedprivatekeyinfo_pem_enco
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x6d1,
