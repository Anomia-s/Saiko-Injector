/**
 * Function: ml_dsa_44_to_encryptedprivatekeyinfo_der_enco
 * Address:  140d626d0
 * Signature: undefined ml_dsa_44_to_encryptedprivatekeyinfo_der_enco(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_dsa_44_to_encryptedprivatekeyinfo_der_enco
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x6d0,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d627c4;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x5b1,0,0xffffffff,FUN_140d683e0,param_1);
      if (lVar4 != 0) {
