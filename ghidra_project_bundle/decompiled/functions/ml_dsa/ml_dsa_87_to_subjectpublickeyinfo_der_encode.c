/**
 * Function: ml_dsa_87_to_subjectpublickeyinfo_der_encode
 * Address:  140d65b30
 * Signature: undefined ml_dsa_87_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x6e2,
               "ml_dsa_87_to_SubjectPublicKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d65c1f;
    }
    lVar4 = key_to_pubkey(param_3,0x5b3,0,0xffffffff,FUN_140d683c0,param_1);
    if (lVar4 != 0) {
