/**
 * Function: ml_dsa_87_to_subjectpublickeyinfo_pem_encode
 * Address:  140d660a0
 * Signature: undefined ml_dsa_87_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x6e3,
               "ml_dsa_87_to_SubjectPublicKeyInfo_pem_encode");
