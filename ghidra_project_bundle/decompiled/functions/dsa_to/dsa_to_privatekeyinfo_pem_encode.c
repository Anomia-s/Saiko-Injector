/**
 * Function: dsa_to_privatekeyinfo_pem_encode
 * Address:  140d667e0
 * Signature: undefined dsa_to_privatekeyinfo_pem_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x612,
               "dsa_to_PrivateKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d668c5;
    }
    uVar2 = FUN_140d676d0(lVar3,param_3,0x74,"DSA PRIVATE KEY",FUN_140d67cb0,FUN_140d67ec0,param_1);
  }
LAB_140d668c5:
  FUN_140b73150(lVar3);
  return uVar2;
