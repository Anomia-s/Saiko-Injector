/**
 * Function: dsa_to_subjectpublickeyinfo_pem_encode
 * Address:  140d66ab0
 * Signature: undefined dsa_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 320 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x614,
               "dsa_to_SubjectPublicKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d66b95;
    }
    uVar2 = FUN_140d67810(lVar3,param_3,0x74,"DSA PUBLIC KEY",FUN_140d67cb0,FUN_140d67df0,param_1);
  }
LAB_140d66b95:
  FUN_140b73150(lVar3);
  return uVar2;
