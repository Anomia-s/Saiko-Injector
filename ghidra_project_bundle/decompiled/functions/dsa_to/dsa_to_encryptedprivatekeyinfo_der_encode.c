/**
 * Function: dsa_to_encryptedprivatekeyinfo_der_encode
 * Address:  140d66380
 * Signature: undefined dsa_to_encryptedprivatekeyinfo_der_encode(void)
 * Body size: 392 bytes
 */
...

{
  ...
  uStack_10 = 0x140d66390;
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x60f,
               "dsa_to_EncryptedPrivateKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d664ad;
    }
    local_18 = 0;
    local_res20[0] = 0xffffffff;
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      iVar1 = FUN_140d67cb0(param_3,0x74,*(undefined4 *)(param_1 + 1),&local_18,local_res20);
      uVar5 = 0;
      if (iVar1 != 0) {
        lVar4 = p8info_to_encp8(param_3,0x74,local_18,local_res20[0],FUN_140d67ec0,param_1);
        if (lVar4 != 0) {
