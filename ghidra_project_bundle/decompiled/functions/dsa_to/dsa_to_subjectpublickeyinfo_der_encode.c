/**
 * Function: dsa_to_subjectpublickeyinfo_der_encode
 * Address:  140d66920
 * Signature: undefined dsa_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 387 bytes
 */
...

{
  ...
  uStack_10 = 0x140d66930;
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x613,
               "dsa_to_SubjectPublicKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d66a48;
    }
    local_18 = 0;
    local_res20[0] = 0xffffffff;
    iVar1 = FUN_140d67cb0(param_3,0x74,*(undefined4 *)(param_1 + 1),&local_18,local_res20);
    if (iVar1 != 0) {
      lVar4 = key_to_pubkey(param_3,0x74,local_18,local_res20[0],FUN_140d67df0,param_1);
      if (lVar4 != 0) {
