/**
 * Function: Unwind@14029f740
 * Address:  14029f740
 * Signature: undefined Unwind@14029f740(void)
 * Body size: 143 bytes
 */


void Unwind_14029f740(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x57) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x30)) {
      lVar5 = FUN_1401a9e60();
