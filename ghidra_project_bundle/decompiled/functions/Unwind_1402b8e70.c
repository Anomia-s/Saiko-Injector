/**
 * Function: Unwind@1402b8e70
 * Address:  1402b8e70
 * Signature: undefined Unwind@1402b8e70(void)
 * Body size: 177 bytes
 */


void Unwind_1402b8e70(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400440d0(param_2 + 0xc0);
  FUN_1400440d0(param_2 + 0xe0);
  if ((*(byte *)(param_2 + 0x106) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xa8)) {
      lVar5 = FUN_1401a9e60();
