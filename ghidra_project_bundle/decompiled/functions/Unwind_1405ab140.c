/**
 * Function: Unwind@1405ab140
 * Address:  1405ab140
 * Signature: undefined Unwind@1405ab140(void)
 * Body size: 294 bytes
 */


void Unwind_1405ab140(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x8e7) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x8d0)) {
      lVar5 = FUN_1401a9e60();
