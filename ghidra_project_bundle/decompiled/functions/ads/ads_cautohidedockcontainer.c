/**
 * Function: ads_cautohidedockcontainer
 * Address:  1402945b0
 * Signature: undefined ads_cautohidedockcontainer(void)
 * Body size: 270 bytes
 */


int ads_cautohidedockcontainer(void)

{
  ...
  if (DAT_1416bad24 != 0) {
    return DAT_1416bad24;
  }
  pcVar3 = QMetaObject::className((QMetaObject *)&DAT_140dfe250);
  ...
  if ((local_30 == (undefined *)0x0) ||
    ...
    if (local_38 == 0) goto LAB_14029467e;
  }
  else {
    sVar4 = strlen(pcVar3);
    _Buf1 = QByteArray::begin(local_48);
    if (local_38 == sVar4) {
LAB_14029467e:
      if ((sVar4 == 0) || (iVar2 = memcmp(_Buf1,pcVar3,sVar4), iVar2 == 0)) goto LAB_1402946a3;
    }
  }
