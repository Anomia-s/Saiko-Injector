/**
 * Function: ads_cdockwidget
 * Address:  1402949c0
 * Signature: undefined ads_cdockwidget(void)
 * Body size: 270 bytes
 */


int ads_cdockwidget(void)

{
  ...
  if (DAT_1416bad30 != 0) {
    return DAT_1416bad30;
  }
  pcVar3 = QMetaObject::className((QMetaObject *)&DAT_140e00e30);
  ...
  if ((local_30 == (undefined *)0x0) ||
    ...
    if (local_38 == 0) goto LAB_140294a8e;
  }
  else {
    sVar4 = strlen(pcVar3);
    _Buf1 = QByteArray::begin(local_48);
    if (local_38 == sVar4) {
LAB_140294a8e:
      if ((sVar4 == 0) || (iVar2 = memcmp(_Buf1,pcVar3,sVar4), iVar2 == 0)) goto LAB_140294ab3;
    }
  }
