/**
 * Function: ads_cfloatingdockcontainer
 * Address:  140294b40
 * Signature: undefined ads_cfloatingdockcontainer(void)
 * Body size: 270 bytes
 */


int ads_cfloatingdockcontainer(void)

{
  ...
  if (DAT_1416bad34 != 0) {
    return DAT_1416bad34;
  }
  pcVar3 = QMetaObject::className((QMetaObject *)&DAT_140e014e0);
  ...
  if ((local_30 == (undefined *)0x0) ||
    ...
    if (local_38 == 0) goto LAB_140294c0e;
  }
  else {
    sVar4 = strlen(pcVar3);
    _Buf1 = QByteArray::begin(local_48);
    if (local_38 == sVar4) {
LAB_140294c0e:
      if ((sVar4 == 0) || (iVar2 = memcmp(_Buf1,pcVar3,sVar4), iVar2 == 0)) goto LAB_140294c33;
    }
  }
