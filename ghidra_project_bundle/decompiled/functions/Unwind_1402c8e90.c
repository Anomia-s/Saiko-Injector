/**
 * Function: Unwind@1402c8e90
 * Address:  1402c8e90
 * Signature: undefined Unwind@1402c8e90(void)
 * Body size: 189 bytes
 */


void Unwind_1402c8e90(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1402c9260(param_2 + 0x28d0);
  if ((*(byte *)(param_2 + 0x297d) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x28b0)) {
      lVar5 = FUN_1401a9e60();
