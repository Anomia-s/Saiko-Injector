/**
 * Function: dsa_sha2_512_verify_init
 * Address:  140d3e250
 * Signature: undefined dsa_sha2_512_verify_init(void)
 * Body size: 488 bytes
 */
...
undefined8 dsa_sha2_512_verify_init(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x20;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,"SHA2-512",0,"DSA-SHA2-512 Verify Init");
  if (iVar1 == 0) {
    return 0;
  }
