/**
 * Function: Unwind@1402811c0
 * Address:  1402811c0
 * Signature: undefined Unwind@1402811c0(void)
 * Body size: 141 bytes
 */


void Unwind_1402811c0(undefined8 param_1,longlong param_2)

{
  ...
  FUN_140580070(param_2 + 0x30);
  if ((*(byte *)(param_2 + 0xd7) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 200)) {
      lVar5 = FUN_1401a9e60();
