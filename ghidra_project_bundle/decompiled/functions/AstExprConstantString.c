 ...
 * Address:  1406c2460
 * Signature: void __thiscall AstExprConstantString(AstExprConstantString * this, undefined8 * param_1, undefined8 * param_2, undefined4 param_3)
 * Body size: 52 bytes
 */
...
Luau::AstExprConstantString::AstExprConstantString
          (AstExprConstantString *this,undefined8 *param_1,undefined8 *param_2,undefined4 param_3)

{
  ...
  this->vftablePtr = (AstExprConstantString_vftable *)&AstNode::vftable;
