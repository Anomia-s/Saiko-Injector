/**
 * Function: Unwind@1402c8d10
 * Address:  1402c8d10
 * Signature: undefined Unwind@1402c8d10(void)
 * Body size: 180 bytes
 */


void Unwind_1402c8d10(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x297f) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x28c0)) {
      lVar5 = FUN_1401a9e60();
