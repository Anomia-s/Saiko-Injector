/**
 * Function: Unwind@1402b9a80
 * Address:  1402b9a80
 * Signature: undefined Unwind@1402b9a80(void)
 * Body size: 151 bytes
 */


void Unwind_1402b9a80(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400017d0(param_2 + 0x30);
  if ((*(byte *)(param_2 + 0x67) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x58)) {
      lVar5 = FUN_1401a9e60();
