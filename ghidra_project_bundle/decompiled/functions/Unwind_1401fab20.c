/**
 * Function: Unwind@1401fab20
 * Address:  1401fab20
 * Signature: undefined Unwind@1401fab20(void)
 * Body size: 288 bytes
 */


void Unwind_1401fab20(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xb87) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xb78)) {
      lVar5 = FUN_1401a9e60();
