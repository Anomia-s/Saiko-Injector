/**
 * Function: dtls1_write_bytes
 * Address:  140bf1f20
 * Signature: undefined dtls1_write_bytes(void)
 * Body size: 396 bytes
 */
...
undefined8
dtls1_write_bytes(longlong param_1,undefined1 param_2,undefined8 param_3,ulonglong param_4,
                 longlong *param_5)

{
  ...
  uStack_10 = 0x140bf1f3b;
  if (param_4 < 0x4001) {
    *(undefined4 *)(param_1 + 0x68) = 1;
    if ((*(int *)(param_1 + 0x1c4) < 1) ||
       (uVar3 = (**(code **)(*(longlong *)(param_1 + 0x18) + 0x90))(), 0 < (int)uVar3)) {
      if (param_4 != 0) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo();
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("ssl\\record\\rec_layer_d1.c",0x271,"dtls1_write_bytes");
