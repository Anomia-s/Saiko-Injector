/**
 * Function: dh_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d64160
 * Signature: undefined dh_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 652 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x602,
               "dh_to_EncryptedPrivateKeyInfo_pem_encode");
