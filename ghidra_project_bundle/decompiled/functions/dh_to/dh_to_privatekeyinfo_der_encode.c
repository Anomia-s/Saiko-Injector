/**
 * Function: dh_to_privatekeyinfo_der_encode
 * Address:  140d64530
 * Signature: undefined dh_to_privatekeyinfo_der_encode(void)
 * Body size: 400 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x603,
               "dh_to_PrivateKeyInfo_der_encode");
    ...
    if (iVar1 == 0) {
      ...
      if (lVar3 != 0) {
        if (param_6 != 0) {
          ...
          if (iVar1 == 0) goto LAB_140d64617;
        }
        uVar2 = FUN_140d67590(lVar3,param_3,0x1c,"DH PRIVATE KEY",FUN_140d679c0,FUN_140d67b90,
                              param_1);
      }
LAB_140d64617:
      FUN_140b73150(lVar3);
