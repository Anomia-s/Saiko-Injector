/**
 * Function: Unwind@1401bef00
 * Address:  1401bef00
 * Signature: undefined Unwind@1401bef00(void)
 * Body size: 234 bytes
 */


void Unwind_1401bef00(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x128) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x138)) {
      lVar5 = FUN_1401a9e60();
