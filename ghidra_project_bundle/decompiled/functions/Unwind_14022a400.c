/**
 * Function: Unwind@14022a400
 * Address:  14022a400
 * Signature: undefined Unwind@14022a400(void)
 * Body size: 136 bytes
 */


void Unwind_14022a400(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xaf) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xa0)) {
      lVar5 = FUN_1401a9e60();
