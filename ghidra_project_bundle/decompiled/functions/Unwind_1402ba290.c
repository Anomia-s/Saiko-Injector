/**
 * Function: Unwind@1402ba290
 * Address:  1402ba290
 * Signature: undefined Unwind@1402ba290(void)
 * Body size: 144 bytes
 */


void Unwind_1402ba290(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xbf) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x78)) {
      lVar5 = FUN_1401a9e60();
  ...
  *(undefined8 *)(param_2 + 0xb0) = *(undefined8 *)(param_2 + 0xa8);
  return;
}
