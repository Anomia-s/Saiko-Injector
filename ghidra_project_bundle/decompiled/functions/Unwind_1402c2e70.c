/**
 * Function: Unwind@1402c2e70
 * Address:  1402c2e70
 * Signature: undefined Unwind@1402c2e70(void)
 * Body size: 177 bytes
 */


void Unwind_1402c2e70(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xdae) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xcd8)) {
      lVar5 = FUN_1401a9e60();
