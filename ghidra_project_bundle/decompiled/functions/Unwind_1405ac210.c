/**
 * Function: Unwind@1405ac210
 * Address:  1405ac210
 * Signature: undefined Unwind@1405ac210(void)
 * Body size: 294 bytes
 */


void Unwind_1405ac210(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x887) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x868)) {
      lVar5 = FUN_1401a9e60();
