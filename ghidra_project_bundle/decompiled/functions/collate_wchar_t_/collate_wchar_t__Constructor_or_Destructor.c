/**
 * Function: collate<wchar_t>_Constructor_or_Destructor
 * Address:  140810740
 * Signature: undefined8 __fastcall collate<wchar_t>_Constructor_or_Destructor(longlong * param_1, undefined8 param_2)
 * Body size: 270 bytes
 */


undefined8
std::collate<wchar_t>::collate<wchar_t>_Constructor_or_Destructor
