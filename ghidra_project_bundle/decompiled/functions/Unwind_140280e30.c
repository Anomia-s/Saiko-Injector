/**
 * Function: Unwind@140280e30
 * Address:  140280e30
 * Signature: undefined Unwind@140280e30(void)
 * Body size: 138 bytes
 */


void Unwind_140280e30(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x116) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x100)) {
      lVar5 = FUN_1401a9e60();
