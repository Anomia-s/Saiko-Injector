/**
 * Function: Unwind@1402c2440
 * Address:  1402c2440
 * Signature: undefined Unwind@1402c2440(void)
 * Body size: 180 bytes
 */


void Unwind_1402c2440(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0xdb0) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xdb8)) {
      lVar5 = FUN_1401a9e60();
