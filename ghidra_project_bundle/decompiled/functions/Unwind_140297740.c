/**
 * Function: Unwind@140297740
 * Address:  140297740
 * Signature: undefined Unwind@140297740(void)
 * Body size: 154 bytes
 */


void Unwind_140297740(undefined8 param_1,longlong param_2)

{
  ...
  FUN_1400440d0(param_2 + 0x240);
  if ((*(byte *)(param_2 + 0x27e) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x200)) {
      lVar5 = FUN_1401a9e60();
