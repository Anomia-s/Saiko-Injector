/**
 * Function: Unwind@1401bfef0
 * Address:  1401bfef0
 * Signature: undefined Unwind@1401bfef0(void)
 * Body size: 234 bytes
 */


void Unwind_1401bfef0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x120) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x128)) {
      lVar5 = FUN_1401a9e60();
