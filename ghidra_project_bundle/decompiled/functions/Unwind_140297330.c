/**
 * Function: Unwind@140297330
 * Address:  140297330
 * Signature: undefined Unwind@140297330(void)
 * Body size: 142 bytes
 */


void Unwind_140297330(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x270) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x260)) {
      lVar5 = FUN_1401a9e60();
