 ...
 * Address:  1406c32b0
 * Signature: void __thiscall AstStatLocal(AstStatLocal * this, undefined8 * param_1, undefined8 * param_2, undefined8 * param_3, undefined8 * param_4)
 * Body size: 80 bytes
 */
...
Luau::AstStatLocal::AstStatLocal
          (AstStatLocal *this,undefined8 *param_1,undefined8 *param_2,undefined8 *param_3,
          undefined8 *param_4)

{
  ...
  this->vftablePtr = (AstStatLocal_vftable *)&AstNode::vftable;
  ...
  *(undefined8 *)&(this->AstNode_data).offset_0x48 = uVar1;
  *(undefined4 *)&(this->AstNode_data).offset_0x50 = *(undefined4 *)(param_4 + 2);
  return;
}
