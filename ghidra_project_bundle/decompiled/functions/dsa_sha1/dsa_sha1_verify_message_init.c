/**
 * Function: dsa_sha1_verify_message_init
 * Address:  140d3c7c0
 * Signature: undefined dsa_sha1_verify_message_init(void)
 * Body size: 333 bytes
 */
...
undefined8 dsa_sha1_verify_message_init(longlong param_1,longlong param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x8000;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,&DAT_1413a6ffc,0,"DSA-SHA1 Verify Message Init");
  if (iVar1 == 0) {
    return 0;
  }
