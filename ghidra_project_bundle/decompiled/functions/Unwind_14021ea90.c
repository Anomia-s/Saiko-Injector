/**
 * Function: Unwind@14021ea90
 * Address:  14021ea90
 * Signature: undefined Unwind@14021ea90(void)
 * Body size: 162 bytes
 */


void Unwind_14021ea90(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x557) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x548)) {
      lVar5 = FUN_1401a9e60();
