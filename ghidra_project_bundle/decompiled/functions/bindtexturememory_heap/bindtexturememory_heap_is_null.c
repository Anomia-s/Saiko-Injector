/**
 * Function: bindtexturememory_heap_is_null
 * Address:  140515330
 * Signature: undefined8 __thiscall bindtexturememory_heap_is_null(void * this, longlong * param_1, longlong * param_2, ulonglong param_3)
 * Body size: 1837 bytes
 */
...
bindtexturememory_heap_is_null(void *this,longlong *param_1,longlong *param_2,ulonglong param_3)

{
  ...
  if (param_1 == (longlong *)0x0) {
    ...
    local_170[2] = (char *)0x22;
    local_158[0] = (basic_streambuf<char,std::char_traits<char>_>)0x2f;
    builtin_strncpy(pcVar8,"bindTextureMemory: texture is NULL",0x23);
    local_170[0] = pcVar8;
...
LAB_1405155a7:
  ...
  if (param_2 == (longlong *)0x0) {
    ...
    local_170[2] = (char *)0x1f;
    local_158[0] = (basic_streambuf<char,std::char_traits<char>_>)0x1f;
    builtin_strncpy(pcVar8,"bindTextureMemory: heap is NULL",0x20);
    local_170[0] = pcVar8;
    (**(code **)(**(longlong **)((longlong)this + 0x18) + 8))
              (*(longlong **)((longlong)this + 0x18),2,pcVar8);
    uVar4 = 0x20;
  ...
  if (*(char *)(lVar3 + 0x4c) != '\0') {
    (**(code **)(**(longlong **)((longlong)this + 0x10) + 0x38))
              (*(longlong **)((longlong)this + 0x10),&local_78,param_1);
    if (local_78 + param_3 <= *puVar2) {
      if (local_70 == 0) {
LAB_1405158f7:
        uVar4 = (**(code **)(**(longlong **)((longlong)this + 0x10) + 0x40))
      ...
      if (uVar10 == 0) goto LAB_1405158f7;
      FUN_1401e87c0(local_170,1);
      uVar4 = FUN_1400e5ec0(local_170 + 2,"Texture ");
...
joined_r0x000140515824:
  ...
  FUN_1401e87c0(local_170,1);
  uVar4 = FUN_1400e5ec0(local_170 + 2,"Cannot perform bindTextureMemory on texture ");
  uVar5 = FUN_140527b30(lVar3 + 0x20);
  uVar4 = FUN_1400e5ec0(uVar4,uVar5);
  ...
  if (((local_e8 & 0x22) == 2) || (uVar10 = *local_118, uVar10 == 0)) {
    if (((local_e8 & 4) == 0) && (*local_120 != 0)) {
      uVar10 = *local_120 + (longlong)*local_108;
      pvVar12 = (void *)*local_140;
      if (pvVar12 != (void *)0x0) goto LAB_140515679;
    }
LAB_140515695:
    ...
    pvVar12 = (void *)*local_138[0];
    if (pvVar12 == (void *)0x0) goto LAB_140515695;
LAB_140515679:
    uVar10 = uVar10 - (longlong)pvVar12;
    if (0xf < uVar10) {
      FUN_1400069b0(&local_68,uVar10);
