/**
 * Function: Unwind@1401bf4f0
 * Address:  1401bf4f0
 * Signature: undefined Unwind@1401bf4f0(void)
 * Body size: 234 bytes
 */


void Unwind_1401bf4f0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x140) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x110)) {
      lVar5 = FUN_1401a9e60();
