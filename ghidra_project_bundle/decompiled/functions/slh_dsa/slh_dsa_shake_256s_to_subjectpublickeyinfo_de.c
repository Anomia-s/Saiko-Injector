/**
 * Function: slh_dsa_shake_256s_to_subjectpublickeyinfo_de
 * Address:  140d5b1f0
 * Signature: undefined slh_dsa_shake_256s_to_subjectpublickeyinfo_de(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_shake_256s_to_subjectpublickeyinfo_de
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x681,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5b2df;
    }
    lVar4 = key_to_pubkey(param_3,0x5be,0,0xffffffff,FUN_140d68630,param_1);
    if (lVar4 != 0) {
