/**
 * Function: slh_dsa_shake_128f_to_encryptedprivatekeyinfo
 * Address:  140d57860
 * Signature: undefined slh_dsa_shake_128f_to_encryptedprivatekeyinfo(void)
 * Body size: 335 bytes
 */
...
undefined4
slh_dsa_shake_128f_to_encryptedprivatekeyinfo
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x654,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d57954;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x5bb,0,0xffffffff,FUN_140d686f0,param_1);
      if (lVar4 != 0) {
