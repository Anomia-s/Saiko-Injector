/**
 * Function: slh_dsa_shake_128s_to_subjectpublickeyinfo_pe
 * Address:  140d5b490
 * Signature: undefined slh_dsa_shake_128s_to_subjectpublickeyinfo_pe(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_shake_128s_to_subjectpublickeyinfo_pe
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x683,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5b57f;
    }
    lVar4 = key_to_pubkey(param_3,0x5ba,0,0xffffffff,FUN_140d68630,param_1);
    if (lVar4 != 0) {
