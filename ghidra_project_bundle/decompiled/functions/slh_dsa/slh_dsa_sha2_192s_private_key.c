/**
 * Function: slh_dsa_sha2_192s_private_key
 * Address:  140d588f0
 * Signature: undefined slh_dsa_sha2_192s_private_key(void)
 * Body size: 313 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x661,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d589ce;
    }
    uVar2 = FUN_140d676d0(lVar3,param_3,0x5b6,"SLH-DSA-SHA2-192s PRIVATE KEY",0,FUN_140d686f0,
                          param_1);
  }
LAB_140d589ce:
  FUN_140b73150(lVar3);
