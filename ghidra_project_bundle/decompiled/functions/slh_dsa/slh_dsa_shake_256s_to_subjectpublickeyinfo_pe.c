/**
 * Function: slh_dsa_shake_256s_to_subjectpublickeyinfo_pe
 * Address:  140d5b9d0
 * Signature: undefined slh_dsa_shake_256s_to_subjectpublickeyinfo_pe(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_shake_256s_to_subjectpublickeyinfo_pe
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x687,
