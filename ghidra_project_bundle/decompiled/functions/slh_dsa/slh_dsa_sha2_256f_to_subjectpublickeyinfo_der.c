/**
 * Function: slh_dsa_sha2_256f_to_subjectpublickeyinfo_der
 * Address:  140d5a380
 * Signature: undefined slh_dsa_sha2_256f_to_subjectpublickeyinfo_der(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_sha2_256f_to_subjectpublickeyinfo_der
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x676,
