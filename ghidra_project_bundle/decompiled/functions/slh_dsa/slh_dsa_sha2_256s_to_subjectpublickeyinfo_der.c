/**
 * Function: slh_dsa_sha2_256s_to_subjectpublickeyinfo_der
 * Address:  140d5a230
 * Signature: undefined slh_dsa_sha2_256s_to_subjectpublickeyinfo_der(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_sha2_256s_to_subjectpublickeyinfo_der
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x675,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5a31f;
    }
    lVar4 = key_to_pubkey(param_3,0x5b8,0,0xffffffff,FUN_140d68630,param_1);
    if (lVar4 != 0) {
