/**
 * Function: slh_dsa_sha2_128f_to_subjectpublickeyinfo_pem
 * Address:  140d5a620
 * Signature: undefined slh_dsa_sha2_128f_to_subjectpublickeyinfo_pem(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_sha2_128f_to_subjectpublickeyinfo_pem
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x678,
