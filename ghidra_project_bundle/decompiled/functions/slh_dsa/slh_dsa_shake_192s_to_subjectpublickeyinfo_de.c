/**
 * Function: slh_dsa_shake_192s_to_subjectpublickeyinfo_de
 * Address:  140d5af50
 * Signature: undefined slh_dsa_shake_192s_to_subjectpublickeyinfo_de(void)
 * Body size: 330 bytes
 */
...
undefined4
slh_dsa_shake_192s_to_subjectpublickeyinfo_de
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x67f,
