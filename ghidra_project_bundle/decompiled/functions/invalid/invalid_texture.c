/**
 * Function: invalid_texture
 * Address:  140514fa0
 * Signature: longlong * __thiscall invalid_texture(void * this, longlong * param_1, longlong * param_2)
 * Body size: 709 bytes
 */
...
longlong * __thiscall invalid_texture(void *this,longlong *param_1,longlong *param_2)

{
  ...
  if (param_2 == (longlong *)0x0) {
    ...
    local_150[2] = (char *)0x2d;
    local_138[0] = (basic_streambuf<char,std::char_traits<char>_>)0x2f;
    builtin_strncpy(pcVar5,"getTextureMemoryRequirements: texture is NULL",0x2e);
    local_150[0] = pcVar5;
  ...
  uVar2 = FUN_1400e5ec0(local_150 + 2,"Invalid texture ");
  lVar3 = (**(code **)(*param_2 + 0x28))(param_2);
  uVar4 = FUN_140527b30(lVar3 + 0x20);
  uVar2 = FUN_1400e5ec0(uVar2,uVar4);
  FUN_1400e5ec0(uVar2,": getTextureMemoryRequirements returned zero size");
    ...
    if (_Src != (void *)0x0) {
      ...
      if (uVar6 < 0x10) {
        ...
        *(undefined1 *)((longlong)&local_58 + uVar6) = 0;
        ...
        goto joined_r0x00014051515e;
      }
      FUN_1400069b0(&local_58,uVar6);
    }
  }
  plVar1 = *(longlong **)((longlong)this + 0x18);
joined_r0x00014051515e:
