/**
 * Function: ecdsa_sha3_512_verify_message_init
 * Address:  140d4b5b0
 * Signature: undefined ecdsa_sha3_512_verify_message_init(void)
 * Body size: 333 bytes
 */
...
undefined8 ecdsa_sha3_512_verify_message_init(longlong param_1,longlong param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x8000;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,"SHA3-512",0,"ECDSA-SHA3-512 Verify Message Init");
  if (iVar1 == 0) {
    return 0;
  }
