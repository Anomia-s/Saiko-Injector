/**
 * Function: ecdsa_sha3_512_sign_init
 * Address:  140d4afe0
 * Signature: undefined ecdsa_sha3_512_sign_init(void)
 * Body size: 491 bytes
 */
...
undefined8 ecdsa_sha3_512_sign_init(longlong param_1,longlong param_2,longlong *param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = s_exceeds_name_buffer_length(param_1,"SHA3-512",0,"ECDSA-SHA3-512 Sign Init");
  if (iVar1 == 0) {
    return 0;
  }
