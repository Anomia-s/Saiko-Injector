/**
 * Function: x448_to_subjectpublickeyinfo_der_encode
 * Address:  140d55910
 * Signature: undefined x448_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x63c,
               "x448_to_SubjectPublicKeyInfo_der_encode");
