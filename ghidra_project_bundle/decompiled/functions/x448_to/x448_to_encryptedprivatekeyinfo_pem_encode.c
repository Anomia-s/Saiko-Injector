/**
 * Function: x448_to_encryptedprivatekeyinfo_pem_encode
 * Address:  140d55540
 * Signature: undefined x448_to_encryptedprivatekeyinfo_pem_encode(void)
 * Body size: 335 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x639,
               "x448_to_EncryptedPrivateKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d55634;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x40b,0,0xffffffff,FUN_140d68310,param_1);
      if (lVar4 != 0) {
