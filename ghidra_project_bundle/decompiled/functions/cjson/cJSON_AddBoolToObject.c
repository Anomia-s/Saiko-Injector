 ...
 * Address:  140583120
 * Signature: undefined cJSON_AddBoolToObject(void)
 * Body size: 273 bytes
 */


undefined8 * cJSON_AddBoolToObject(undefined8 *param_1,char *param_2,int param_3)

{
  ...
  void *_Dst;
                    ...
                    /* 0x583120  2  cJSON_AddBoolToObject */
  ...
  if (puVar3 != (undefined8 *)0x0) {
    ...
    *puVar3 = 0;
    puVar3[1] = 0;
    *(uint *)(puVar3 + 3) = 2 - (uint)(param_3 == 0);
