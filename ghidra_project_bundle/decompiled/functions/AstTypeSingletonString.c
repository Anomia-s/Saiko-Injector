 ...
 * Address:  1406c42f0
 * Signature: void __thiscall AstTypeSingletonString(AstTypeSingletonString * this, undefined8 * param_1, undefined8 * param_2)
 * Body size: 48 bytes
 */
...
Luau::AstTypeSingletonString::AstTypeSingletonString
          (AstTypeSingletonString *this,undefined8 *param_1,undefined8 *param_2)

{
  ...
  this->vftablePtr = (AstTypeSingletonString_vftable *)&AstNode::vftable;
