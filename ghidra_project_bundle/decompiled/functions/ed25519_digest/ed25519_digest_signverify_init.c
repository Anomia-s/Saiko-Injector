/**
 * Function: ed25519_digest_signverify_init
 * Address:  140d458b0
 * Signature: undefined ed25519_digest_signverify_init(void)
 * Body size: 208 bytes
 */
...
undefined8
ed25519_digest_signverify_init(longlong param_1,char *param_2,longlong param_3,undefined8 param_4)

{
  ...
  if ((param_2 != (char *)0x0) && (*param_2 != '\0')) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\signature\\eddsa_sig.c",0x2a7,
  ...
  if ((iVar1 != 0) && (*(int *)(*(longlong *)(param_1 + 8) + 0x60) == 2)) {
    *(uint *)(param_1 + 0x11c) = *(uint *)(param_1 + 0x11c) & 0xffffffe0;
