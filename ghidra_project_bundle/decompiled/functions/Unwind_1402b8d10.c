/**
 * Function: Unwind@1402b8d10
 * Address:  1402b8d10
 * Signature: undefined Unwind@1402b8d10(void)
 * Body size: 167 bytes
 */


void Unwind_1402b8d10(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x107) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0xb8)) {
      lVar5 = FUN_1401a9e60();
  ...
  *(undefined8 *)(param_2 + 0xf8) = *(undefined8 *)(param_2 + 0xb0);
  return;
}
