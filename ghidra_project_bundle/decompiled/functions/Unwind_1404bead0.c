/**
 * Function: Unwind@1404bead0
 * Address:  1404bead0
 * Signature: undefined Unwind@1404bead0(void)
 * Body size: 222 bytes
 */


void Unwind_1404bead0(undefined8 param_1,longlong param_2)

{
  ...
  if ((*(byte *)(param_2 + 0x5c0) & 1) != 0) {
    lVar4 = FUN_1401a9cc0();
    if (*(longlong *)(lVar4 + 0x290) == *(longlong *)(param_2 + 0x5f8)) {
      lVar5 = FUN_1401a9e60();
