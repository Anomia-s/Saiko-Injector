/**
 * Function: ml_kem_1024_to_subjectpublickeyinfo_pem_encod
 * Address:  140d5d350
 * Signature: undefined ml_kem_1024_to_subjectpublickeyinfo_pem_encod(void)
 * Body size: 330 bytes
 */
...
undefined4
ml_kem_1024_to_subjectpublickeyinfo_pem_encod
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x69f,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5d43f;
    }
    lVar4 = key_to_pubkey(param_3,0x5b0,0,0xffffffff,FUN_140d68400,param_1);
    if (lVar4 != 0) {
