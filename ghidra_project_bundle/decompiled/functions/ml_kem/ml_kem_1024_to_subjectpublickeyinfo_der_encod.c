/**
 * Function: ml_kem_1024_to_subjectpublickeyinfo_der_encod
 * Address:  140d5d200
 * Signature: undefined ml_kem_1024_to_subjectpublickeyinfo_der_encod(void)
 * Body size: 330 bytes
 */
...
undefined4
ml_kem_1024_to_subjectpublickeyinfo_der_encod
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x69e,
