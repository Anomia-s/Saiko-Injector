/**
 * Function: ml_kem_768_to_privatekeyinfo_der_encode
 * Address:  140d5c770
 * Signature: undefined ml_kem_768_to_privatekeyinfo_der_encode(void)
 * Body size: 313 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x695,
               "ml_kem_768_to_PrivateKeyInfo_der_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5c84e;
    }
    uVar2 = FUN_140d67590(lVar3,param_3,0x5af,"ML-KEM-768 PRIVATE KEY",0,FUN_140d68420,param_1);
  }
LAB_140d5c84e:
  FUN_140b73150(lVar3);
  return uVar2;
