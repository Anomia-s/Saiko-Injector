/**
 * Function: ml_kem_512_to_subjectpublickeyinfo_pem_encode
 * Address:  140d5c330
 * Signature: undefined ml_kem_512_to_subjectpublickeyinfo_pem_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x691,
               "ml_kem_512_to_SubjectPublicKeyInfo_pem_encode");
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5c41f;
    }
    lVar4 = key_to_pubkey(param_3,0x5ae,0,0xffffffff,FUN_140d68400,param_1);
    if (lVar4 != 0) {
