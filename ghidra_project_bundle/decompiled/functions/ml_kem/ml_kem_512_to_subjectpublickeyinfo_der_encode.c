/**
 * Function: ml_kem_512_to_subjectpublickeyinfo_der_encode
 * Address:  140d5c1e0
 * Signature: undefined ml_kem_512_to_subjectpublickeyinfo_der_encode(void)
 * Body size: 330 bytes
 */
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x690,
               "ml_kem_512_to_SubjectPublicKeyInfo_der_encode");
