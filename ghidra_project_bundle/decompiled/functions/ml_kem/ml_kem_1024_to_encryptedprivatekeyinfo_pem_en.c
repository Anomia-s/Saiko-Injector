/**
 * Function: ml_kem_1024_to_encryptedprivatekeyinfo_pem_en
 * Address:  140d5ce30
 * Signature: undefined ml_kem_1024_to_encryptedprivatekeyinfo_pem_en(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_kem_1024_to_encryptedprivatekeyinfo_pem_en
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x69b,
