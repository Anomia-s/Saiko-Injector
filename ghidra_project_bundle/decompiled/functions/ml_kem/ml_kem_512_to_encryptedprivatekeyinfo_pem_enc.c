/**
 * Function: ml_kem_512_to_encryptedprivatekeyinfo_pem_enc
 * Address:  140d5be10
 * Signature: undefined ml_kem_512_to_encryptedprivatekeyinfo_pem_enc(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_kem_512_to_encryptedprivatekeyinfo_pem_enc
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x68d,
  ...
  if (lVar3 != 0) {
    if (param_6 != 0) {
      ...
      if (iVar1 == 0) goto LAB_140d5bf04;
    }
    if (*(int *)((longlong)param_1 + 0xc) != 0) {
      lVar4 = p8info_to_encp8(param_3,0x5ae,0,0xffffffff,FUN_140d68420,param_1);
      if (lVar4 != 0) {
