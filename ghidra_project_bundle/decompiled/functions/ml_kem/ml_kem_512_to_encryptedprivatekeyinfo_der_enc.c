/**
 * Function: ml_kem_512_to_encryptedprivatekeyinfo_der_enc
 * Address:  140d5bcc0
 * Signature: undefined ml_kem_512_to_encryptedprivatekeyinfo_der_enc(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_kem_512_to_encryptedprivatekeyinfo_der_enc
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x68c,
