/**
 * Function: ml_kem_768_to_encryptedprivatekeyinfo_pem_enc
 * Address:  140d5c620
 * Signature: undefined ml_kem_768_to_encryptedprivatekeyinfo_pem_enc(void)
 * Body size: 335 bytes
 */
...
undefined4
ml_kem_768_to_encryptedprivatekeyinfo_pem_enc
...

{
  ...
  if ((param_4 != 0) || ((param_5 & 1) == 0)) {
    ...
    d_aplatformplatformopenssl_srccryptoerrerr_lo
              ("providers\\implementations\\encode_decode\\encode_key2any.c",0x694,
